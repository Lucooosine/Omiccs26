...
## Step 4 Population Differentiation Analysis

After exploring the overall population structure with PCA and ADMIXTURE, we now investigate how genetically differentiated the selected grapevine groups are and how genetic diversity is distributed across the genome.

In this part of the project, we will use:
- FST to measure genetic differentiation between populations
- nucleotide diversity (π) to measure within-population diversity
- π ratio to compare diversity between groups

These statistics will help us identify the most interesting group comparisons and genomic regions for further interpretation.
